...
def event_triger():   
    ...
    #await channel_layer.group_send(
        'event_sharif',
        {
            ...
            'message14': Webalarm[0],
            'message15': Webalarm[1],
            'message16': Webalarm[2],
...
def main1(): 
    ...
    while updateflag == 1:
        ...
        if dummyelapsedTime < 2:
            NowAL = ["0000000000000000","0000000000000000","0000000000000000","0000000000000000","0000000000000000","0000000000000000"]
        if 2 <= dummyelapsedTime and dummyelapsedTime < 5:
            NowAL = ["0000000000000000","0000000000000000","0000000000000001","0000000000000000","0000000000000000","0000000000000000"]
        if 5 <= dummyelapsedTime and dummyelapsedTime < 10:
            NowAL = ["0000000000000000","0000000000000100","0000000000000001","0000000000000000","0000000000000000","0000000000000000"]
        if 10 <= dummyelapsedTime and dummyelapsedTime < 13:
            NowAL = ["0000000000000000","0000000000000100","0000000000000001","0100000000000000","0000000000000000","0000000000000000"]
        if 13 <= dummyelapsedTime and dummyelapsedTime < 18:
            NowAL = ["0000000000000000","0000000000000100","0000000010000001","0100000000000000","0000000000000000","0000000000000000"]
        if 18 <= dummyelapsedTime and dummyelapsedTime < 26: 
            NowAL = ["0000000000000000","0000000000000000","0000000010000000","0000000000000100","0000000000000000","0000000000000000"]
        if 26 <= dummyelapsedTime and dummyelapsedTime < 38: 
            NowAL = ["0000000000000000","0000000000000000","0000100000000000","0000000000000100","0000000000000000","0000000000000000"]
        if 38 <= dummyelapsedTime and dummyelapsedTime < 69: 
            NowAL = ["0000000000010000","0000000000000000","0000100000000000","0000000000000100","0000000000000000","0000000000000000"]
        if 69 <= dummyelapsedTime:
            NowAL = ["0000000000000000","0000000000000000","0000100000000000","0000000000000100","0000000000000000","0000000000000000"]
